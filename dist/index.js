...
`);
    ...
    convertBadge(badge) {
        if (badge.data.type === "code-quality") {
            ...
            return (0,_core_option_js__WEBPACK_IMPORTED_MODULE_0__/* .Some */ .bD)(`[![badge](https://img.shields.io/badge/${n}` +
                `-${d.qualityRating}` +
                `-${color})](${badge.url})`);
        }
        return (0,_core_option_js__WEBPACK_IMPORTED_MODULE_0__/* .None */ .Hq)();
...
`);
    ...
    convertBadge(badge) {
        if (badge.data.type === "documentation") {
            const n = encodeURIComponent(badge.name);
            return (0,_core_option_js__WEBPACK_IMPORTED_MODULE_0__/* .Some */ .bD)(`[![badge](https://img.shields.io/badge/${n}-blue?style=for-the-badge)](${badge.url})`);
        }
        return (0,_core_option_js__WEBPACK_IMPORTED_MODULE_0__/* .None */ .Hq)();
    }
}
