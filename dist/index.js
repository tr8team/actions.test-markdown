...
`);
    ...
    convertBadge(badge) {
        if (badge.data.type === "code-quality") {
            const color = (0,_util_js__WEBPACK_IMPORTED_MODULE_1__/* .resultToColor */ .mu)(badge.data.result);
            const d = badge.data;
            return (0,_core_option_js__WEBPACK_IMPORTED_MODULE_0__/* .Some */ .bD)(`[![badge](https://img.shields.io/badge/${badge.name}` +
                `-${d.qualityRating}` +
                `-${color})](${badge.url})`);
        }
        return (0,_core_option_js__WEBPACK_IMPORTED_MODULE_0__/* .None */ .Hq)();
...
//# sourceMappingURL=data:application/json;base64,
...
`);
    ...
    convertBadge(badge) {
        if (badge.data.type === "documentation") {
            return (0,_core_option_js__WEBPACK_IMPORTED_MODULE_0__/* .Some */ .bD)(`[![badge](https://img.shields.io/badge/${badge.name})](${badge.url})`);
        }
        return (0,_core_option_js__WEBPACK_IMPORTED_MODULE_0__/* .None */ .Hq)();
    }
}
...
`);
    ...
    convertBadge(table) {
        if (table.data.type === "test-result") {
            ...
            const d = table.data;
            // ✔ HELLO | ✘ HELLO | ➟ HELLO
            return (0,_core_option_js__WEBPACK_IMPORTED_MODULE_0__/* .Some */ .bD)(`[![badge](https://img.shields.io/badge/${table.name}` +
                `-%E2%9C%94%20${d.pass}%20%7C%20%E2%9C%98%20${d.fail}%20%7C%20%E2%9E%9F%20${d.skip}` +
                `-${color})](${table.url})`);
        }
        return (0,_core_option_js__WEBPACK_IMPORTED_MODULE_0__/* .None */ .Hq)();
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/zod@3.22.0/node_modules/zod/lib/index.mjs
var util;
(function (util) {
...
class SimpleRenderService {
    ...
    render(input) {
        ...
        const badge = _core_result_js__WEBPACK_IMPORTED_MODULE_0__/* .Res.all */ .LV.all(...badges).map((x) => x.join(" "));
...
/* harmony import */ var _lib_input_js__WEBPACK_IMPORTED_MODULE_5__ = __nccwpck_require__(8153);
